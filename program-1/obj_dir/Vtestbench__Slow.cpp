...
void Vtestbench::_ctor_var_reset() {
    ...
    testbench__DOT__dut__DOT__insn_stage2 = VL_RAND_RESET_I(32);
    ...
    testbench__DOT__dut__DOT__pnpc = VL_RAND_RESET_I(32);
    testbench__DOT__dut__DOT__next_wr_stall = VL_RAND_RESET_I(1);
    testbench__DOT__dut__DOT__next_wr_bypass = VL_RAND_RESET_I(1);
    ...
    testbench__DOT__dut__DOT__stall_stage2 = VL_RAND_RESET_I(1);
    testbench__DOT__dut__DOT__re1_enable = VL_RAND_RESET_I(1);
    testbench__DOT__dut__DOT__re2_enable = VL_RAND_RESET_I(1);
    testbench__DOT__dut__DOT__bypass_rs1 = VL_RAND_RESET_I(1);
    testbench__DOT__dut__DOT__bypass_rs2 = VL_RAND_RESET_I(1);
    testbench__DOT__dut__DOT__kill_jmp = VL_RAND_RESET_I(1);
    testbench__DOT__dut__DOT__kill_jmp_stage2 = VL_RAND_RESET_I(1);
    testbench__DOT__dut__DOT__reset_q = VL_RAND_RESET_I(1);
    testbench__DOT__dut__DOT__mem_rdata = VL_RAND_RESET_I(32);
    __Vchglast__TOP__testbench__DOT__dut__DOT__stall = VL_RAND_RESET_I(1);
